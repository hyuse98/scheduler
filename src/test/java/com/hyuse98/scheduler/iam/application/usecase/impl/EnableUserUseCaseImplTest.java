...
class EnableUserUseCaseImplTest {
    ...
    @InjectMocks
    private EnableUserUseCaseImpl enableUserUseCase;

    @Test
    void shouldEnableUserSuccessfully() {
        UUID userId = UUID.randomUUID();
        User disabledUser = User.reconstitute(userId, Email.of("test@example.com"), Password.fromHashed("pass"), Set.of(Role.ROLE_USER), false);
        ...
        assertTrue(eventCaptor.getValue().isActive());
    }
